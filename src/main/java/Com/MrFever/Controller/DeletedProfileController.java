...
import Com.MrFever.Dao.DeletedProfileDao;
...
public class DeletedProfileController implements Initializable {
	
	DeletedProfileDao dPDao = new DeletedProfileDao();
