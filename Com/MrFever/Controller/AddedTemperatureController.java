...
public class AddedTemperatureController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		// Initializing inserting data to table 'temperature' in database
		try {
			aTDao.addedTemperature();
		} catch (ClassNotFoundException | SQLException | InterruptedException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		
		// viewing message for adding temperature
		messageField.setText("Temperature was added");
